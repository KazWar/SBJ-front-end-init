...
using RMS.MultiTenancy.HostDashboard;
...
namespace RMS.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(RMSDbContext context, SubscriptionPayment subscriptionPayment)
        {
